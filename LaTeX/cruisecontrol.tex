...
\begin{document}
	...
	\begin{itemize}
		...
		\item Because the system is offline updating the software will need to be done by a mechanic. If the rate of new features being made available becomes faster than the rate consumers purchase new cars it may become more convenient to enable wireless updates.
	\end{itemize}
